...
def chat():
    ...
    if user_id not in user_sessions:
        ...
        user_sessions[user_id] = [
            {'role': 'system', 'content': 'You are a helpful physics tutor. Your task is to solve physics problems step by step. Start by asking the user if they have a physics question or if they need help solving a physics problem. Do not move to the next step until the user responds,and include equations and explanations clearly.'}
        ]
